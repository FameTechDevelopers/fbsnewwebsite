...
const Portofolio = () => {
  ...
  return (
    <>
      <div id="projects" className=" mt-14 mb-16">
        ...
        <div className="grid grid-cols-12 w-full mx-auto">
          <div className=" md:col-span-3 col-span-12">
            <div className="flex md:flex-col flex-wrap justify-evenly md:px-4 px-0 py-4 md:mx-auto w-[100%] mb-12 z-30 rounded-full">
              <button
          ...
          <div className=" h-[80vh] md:col-span-9 col-span-12 overflow-y-scroll">
            {activeTab == 0 ? (
